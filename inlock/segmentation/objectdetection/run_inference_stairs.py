...
image_path = image_dir + "/CAB_E_VF_20230609-1.png"
...
model_save_path = "object_detection5_model.pt_epoch_800.pt"
...
# Run inference
proposals_final, conf_scores_final, classes_final = detector.inference(image_tensor, conf_thresh=0.8, nms_thresh=0.7)
...
fig, _ = display_bbox_stairs(prop_proj_1, fig, ax, classes=classes_pred_1)
...
plt.savefig("prediction_stairs.png")
plt.show()
